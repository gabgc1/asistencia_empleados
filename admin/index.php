            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  <?php echo ($page == 'employees') ? 'active' : '' ?>" href="./?page=employees"><i class="fa fa-user-friends"></i> Empleados</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  <?php echo ($page == 'attendance_list') ? 'active' : '' ?>" href="./?page=attendance_list"><i class="fa fa-th-list"></i> Asistencia</a>
                        </li>
                        <?php if ($_SESSION['type'] == 1) : ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo ($page == 'admin') ? 'active' : '' ?>" aria-current="page" href="./?page=admin"><i class="fa fa-users"></i> Usuarios</a>
                            </li>
                        <?php endif; ?>
